...
public class Game implements ActionListener {
  ...
  /**                                           
   * This is the default method to read data and create the trivia game. It also sets up all the details in the frame and adds the data from the ArrayList
  */
  Game() {
    String fileName;
    FileReader myFile;
  ...
  /**
   * This method uses an ArrayList to move to the next question while resetting each answer choice
  */
  void NextQuestion() {
    ask.setText("");
  ...
  /**
   * This method allows buttons to work as specified
  */
